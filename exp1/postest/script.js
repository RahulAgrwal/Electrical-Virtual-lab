...
function showQuetions(index) {
    ...
    let que_tag = '<span>' + questions[index].numb + ". " + questions[index].question + '<br>'+questions[index].image+'</span>';
...
function startTimer(time) {
    ...
    function timer() {
        ...
        if (time < 0) { //if timer is less than 0
            ...
            next_btn.classList.add("    "); //show the next button if user selected any option
        }
    }
}
